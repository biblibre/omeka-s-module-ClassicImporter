 ...
 */
class ClassicImporterImport extends \ClassicImporter\Entity\ClassicImporterImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassicImporterImport $proxy) {
