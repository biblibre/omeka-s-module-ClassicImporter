 ...
 */
class ClassicImporterResourceMap extends \ClassicImporter\Entity\ClassicImporterResourceMap implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClassicImporterResourceMap $proxy) {
